...
def _save(fig, name):
    ...
    # above this makes every rerun produce byte-identical SVGs, so a reader can
    # verify the figures were generated by this code and not edited by hand.
